...
int main()
{
	...
	int b = v[1][0] - '0';
	int c = v[0][0] - '0';
	if(v[0][1] == v[1][1] and v[1][1] == v[2][1])
	{
		if(a == (b + 1) and a == (c + 2))
		{
			ans = 0;
	...
	if(a == (b + 1) and  v[2][1] == v[1][1])
		ans = min(ans,1ll);
	if(b == (c + 1) and v[1][1] == v[0][1])
		ans = min(ans,1ll);
	if(v[0][1] == v[2][1] and a == (c + 1))
		ans = min(ans,1ll);
	if(a == (b + 2) and v[2][1] == v[1][1])
		ans = min(ans,1ll);
	if(b == (c + 2) and v[1][1] == v[0][1])
		ans = min(ans,1ll);
	if(a == (c + 2) and v[2][1] == v[0][1])
		ans = min(ans,1ll);
	th(ans);
